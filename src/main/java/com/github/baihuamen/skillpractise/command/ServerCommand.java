...
public class ServerCommand {
    ...
    public Consumer<CommandContext<ServerCommandSource>> commandHandler;
    public ServerCommand(String commandName,List<String> aliases, Consumer<CommandContext<ServerCommandSource>> commandHandler){
