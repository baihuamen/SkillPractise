...
public class SkillPractiseScreenConfig {
    ...
    public static int backKeyX = 0;
    public static boolean enabledLeftKeyChart = true;
    public static int leftKeyX = 200;
    public static boolean enabledRightKeyChart = true;
    public static int rightKeyX = 300;
}
